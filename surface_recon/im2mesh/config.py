...
# Trainer
def get_trainer(model, optimizer, cfg, device,scheduler=None,scheduler_type=None, max_val=5):
    ...
    trainer = method_dict[method].config.get_trainer(
        model, optimizer, cfg, device,scheduler,scheduler_type, max_val=max_val)
    return trainer
...
# Datasets
def get_dataset(mode, cfg, return_idx=False, return_category=False, model_list=None, n_internal_epochs=1):
    ''' Returns the dataset.
