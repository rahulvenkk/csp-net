...
dmc_pred2mesh_module = CppExtension(
    'im2mesh.dmc_udf_general.ops.cpp_modules.pred2mesh',
    sources=[
        'im2mesh/dmc_udf_general/ops/cpp_modules/pred_to_mesh_.cpp',
    ]   
)

dmc_cuda_module = CUDAExtension(
    'im2mesh.dmc_udf_general.ops._cuda_ext', 
    sources=[
        'im2mesh/dmc_udf_general/ops/src/extension.cpp',
        'im2mesh/dmc_udf_general/ops/src/curvature_constraint_kernel.cu',
        'im2mesh/dmc_udf_general/ops/src/grid_pooling_kernel.cu',
        'im2mesh/dmc_udf_general/ops/src/occupancy_to_topology_kernel.cu',
        'im2mesh/dmc_udf_general/ops/src/occupancy_connectivity_kernel.cu',
        'im2mesh/dmc_udf_general/ops/src/point_triangle_distance_kernel.cu',
    ]
)
