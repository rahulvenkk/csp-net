...
parser.add_argument('--max_train', type=int,
                         help='Max Size of train set.', default=30000)
...
all_samples = [name for name in all_samples
               if len(os.listdir(os.path.join(args.in_folder, name))) > 1]
...
# Select elements
n_train = min(n_train, args.max_train)
